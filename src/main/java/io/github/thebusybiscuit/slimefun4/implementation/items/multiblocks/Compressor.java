...
public class Compressor extends MultiBlockMachine {
    ...
    public Compressor(ItemGroup itemGroup, SlimefunItemStack item) {
        super(itemGroup, item, new ItemStack[] { null, null, null, null, new ItemStack(Material.NETHER_BRICK_FENCE), null, new ItemStack(Material.PISTON), CustomItemStack.create(Material.DISPENSER, "发射器（朝上）"), new ItemStack(Material.PISTON) }, BlockFace.SELF);
    }
