...
class EnderTalisman extends Talisman {
    ...
    private static final LockedItemGroup ENDER_TALISMANS_ITEMGROUP = new LockedItemGroup(new NamespacedKey(Slimefun.instance(), "ender_talismans"), CustomItemStack.create(SlimefunItems.ENDER_TALISMAN.item(), "&7护身符 - &a等级 II"), 3, Talisman.TALISMANS_ITEMGROUP.getKey());
